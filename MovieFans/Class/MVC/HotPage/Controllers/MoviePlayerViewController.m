...
- (void)viewDidLoad {
    ...
    // 创建AVPlayer
    self.playerItem = [AVPlayerItem playerItemWithURL:[NSURL URLWithString:_movieUrl]];
    ...
    self.topView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, _width, _height * 0.12)];
...
- (void)backButton
{
    ...
    button.frame = CGRectMake(15, 20, 40, 25);
