...
#define rectLeftHand CGRectMake(SCREEN_WIDTH/ 2 - 100, loginview.frame.origin.y - 22, 40, 40)
#define rectRightHand CGRectMake(SCREEN_WIDTH/ 2 + 62, loginview.frame.origin.y - 22, 40, 40)

@interface CatAnimationLogin()<UITextFieldDelegate>
...
@implementation CatAnimationLogin
...
-(void)drawView{
    ...
    UIImageView* header = [[UIImageView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/ 2 - 211 / 2, 50, 211, 109)];
    ...
    UIView *loginview=[[UIView alloc]initWithFrame:CGRectMake(15, 150, SCREEN_WIDTH-30, 160)];
    ...
    _userNameTextField=[[UITextField alloc]initWithFrame:CGRectMake(30, 30, SCREEN_WIDTH-90, 44)];
    ...
    _PassWordTextField = [[UITextField alloc] initWithFrame:CGRectMake(30, 90,SCREEN_WIDTH-90, 44)];
